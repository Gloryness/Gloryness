...
My Portfolio Website, built with Flask: [https://gloryness.net/](https://web.archive.org/web/20240827014949/http://gloryness.net/) (via wayback machine)

### 🛰️ Notable Projects I own:
- Vehicle detection with YOLOv8 - 2,000+ manually collected & trained images
- **Questify** - A discord bot ( [forum thread showcase](https://hypixel.net/threads/verified-discord-bot-questify-400-servers.5084583/) | [invite link](https://discord.com/api/oauth2/authorize?client_id=884835091837235210&permissions=2147863552&scope=bot%20applications.commands) ) that generates hypixel questing-related statistics. (700+ servers!)
...
- [Hypixel Goal Tracker](https://github.com/Gloryness/Hypixel-Goal-Tracker) - A peice of software used to track anything on Hypixel. (unmaintained , outdated)
